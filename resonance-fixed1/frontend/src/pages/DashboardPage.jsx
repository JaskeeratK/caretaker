...
export default function DashboardPage({ user, onLogout }) {
  ...
  return (
    <div style={{ background: c.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* CONTENT */}
      <main style={{ flex: 1, padding: '1.75rem', maxWidth: '100%', margin: '0', width: '100%' }}>
        {tab === 'home' && (
          <div>
    ...
    {/* BOTTOM ROW: Talk + Peer Groups */}
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
      {[
        {
          id: 'chat',
          label: 'Talk to Resonance',
          sub: 'Your companion is here',
          illustration: (
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 10 Q8 6 12 6 L36 6 Q40 6 40 10 L40 28 Q40 32 36 32 L26 32 L18 42 L18 32 L12 32 Q8 32 8 28 Z" stroke="#c9a84c" strokeWidth="1.2" fill="none" strokeLinejoin="round"/>
              <line x1="16" y1="16" x2="32" y2="16" stroke="#8aaa96" strokeWidth="1" strokeLinecap="round"/>
              <line x1="16" y1="21" x2="28" y2="21" stroke="#8aaa96" strokeWidth="1" strokeLinecap="round"/>
            </svg>
          ),
        },
        {
